...
function NavBar() {
  ...
  const button3Items = [
    ...
    { text: "Book your stay", link: "/reservation" },
  ];
  return (
    <div>
      <div
        className={
          isSticky ? "navigator-container sticky" : "navigator-container"
        }
      >
        <img
          className="logo"
          src="https://www.chateaudefeuilles.com/images/chateau_de_feuilles-logo3.svg"
          alt="SVG Image"
        />
        ...
        {windowWidth > 1000 ? (
          ...
          <div className="navbar-res-btn" onClick={toggleClicked}>
            <NavResBtn />
          </div>
        )}
      </div>
      {windowWidth > 1000 ? null : clicked ? (
        <div className="new">
          <Accordion />
        </div>
      ) : null}
